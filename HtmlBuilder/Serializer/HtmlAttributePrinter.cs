...
{
    public class HtmlAttributePrinter : IHtmlAttributePrinter
    {
        ...
        {
            var result = Combine(attribute.AttributeName, attribute.Value.ToString());//$"{attribute.AttributeName}=\"{attribute.Value}\"";
            return result;
        }        
